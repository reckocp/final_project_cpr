...
Spotlight.create!(title: 'Austin City Council Meeting', description: 'Come out and meet with your city council members, as well as members of your community to learn more about the important decisions being made that affect you!', date: 'Thursday, June 9th, 2016', url: 'http://www.austintexas.gov/department/city-council/2016_council_meeting_schedule.htm', user_id: 1, level: 'local')
Spotlight.create!(title: 'Texas Democratic Convention', description: 'Come participate in democracy in action! The Democratic Party of Texas will be selecting delegates to send to the national convention in Philadelphia in July!', date: 'June 16-18, 2016', url: 'http://texasdemocraticconvention.com/', user_id: 2, level: 'state')
Spotlight.create!(title: '2016 GOP Convention', description: 'The Republican Party will be coming together to select their candidate to run for President of the United States in Cleveland, Ohio.', date: 'July 18-21, 2016', url: 'http://convention.gop/about', user_id: 4, level: 'national')
